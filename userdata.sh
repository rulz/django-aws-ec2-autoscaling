...
GIT_REPO_URL="https://github.com/rulz/django-aws-ec2-autoscaling.git"
#GIT_REPO_URL="https://<your_username>:<your_PAT>@github.com/rulz/django-aws-ec2-autoscaling.git"
